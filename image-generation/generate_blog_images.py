...
def create_prompt_from_post(title, repo, language, content_preview=""):
    ...
    prompt = f"""Modern tech blog header image for '{repo}' project. 
    Theme: {theme}. 
    Style: minimalist, dark theme with subtle gradients (dark blue to black), 
    professional, clean, geometric shapes, {language} programming language aesthetic.
