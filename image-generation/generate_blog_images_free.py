...
def create_prompt_from_post(title, repo, language):
    ...
    # Prompt optimizado para SDXL
    prompt = (
        f"Professional tech blog header image, {theme}, "
        f"minimalist dark theme, deep blue to black gradient background, "
        f"geometric abstract shapes, modern software engineering aesthetic, "
        f"clean composition, high quality, 16:9 aspect ratio, no text, "
        f"digital art style, cinematic lighting"
    )
